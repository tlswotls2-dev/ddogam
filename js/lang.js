...
window.LANG_UI = {
  ko: {
    ...
    recordsTitle: '나의 기록',
    recordsTabToday: '오늘',
    recordsTabPeriod: '기간별',
    recordsTabRanking: '랭킹',
    recordsTodayMovement: '오늘의 움직임',
    recordsTodayKnowledge: '오늘의 지식',
    recordsUnitSteps: '걸음',
    recordsUnitKcal: 'kcal',
    recordsUnitMinutes: '분',
    recordsUnitCards: '카드 수집',
    recordsUnitQuiz: '퀴즈 정답',
    recordsDailyGoal: '하루 활동 목표 60분',
    recordsPeriodWeek: '이번 주 (일요일부터)',
    recordsPeriodMonth: '이번 달',
    recordsPeriodTotal: '또감 시작 이후 전체',
    recordsUnitActivityMin: '활동분',
    rankCollection: '수집왕',
    rankSteps: '걸음왕',
    rankQuiz: '퀴즈왕',
    rankAttendance: '꾸준왕',
    ...
    rankNoteTotal: '누적',
    rankMe: '나',
    rankFooter: '상위 5명 + 내 순위만 표시',
    rankRefreshNote: '약 1시간마다 갱신돼요',
    rankResetWeekly: '매주 일요일에 순위가 초기화돼요 (새로운 한 주, 새로운 기회!)',
    rankResetQuarterly: '최근 3개월간의 기록이에요 (꾸준함을 길게 응원해요!)',
    rankPeriodWeek: '주간',
    rankPeriodMonth: '월간',
    rankPeriodTotal: '전체',
    rankResetWeeklyShort: '매주 초기화돼요',
    rankResetMonthlyShort: '매달 1일 초기화돼요',
    rankResetTotalShort: '초기화 없이 계속 쌓여요',
    badgeSprout: '새싹 워커',
    badgeStrong: '튼튼 워커',
    badgeChampion: '탐험 대장',
    activitySimilarTo: '분과 비슷해요',
    activityJumpRope: '줄넘기',
    activitySoccer: '축구',
    activityInlineSkate: '인라인스케이트',
    activityBadminton: '배드민턴',
    activityCycling: '자전거 타기',
    activityHulaHoop: '훌라후프',
    recordsLoading: '불러오는 중...',
    recordsLoadFail: '랭킹을 불러오지 못했어요.<br>인터넷 연결을 확인해주세요.',
    rankClassLabel: '반',
    rankNumberLabel: '번',
    exploreBtn: '탐험!',
    dodamBtn: '도감',
    ...
    classDodamDetailBtn: '📋 자세히 보기',
    classDodamDetailTitle: '🌿 우리 반 공동 도감',
    classDodamOwnedBy: '👥 {class}반 {numbers}번 보유',
    classDodamNoOwner: '👥 아직 우리 반에 아무도 없어요',
    classDodamCardUndiscovered: '아직 아무도 모으지 못했어요.',
    demoSimStart: '🎬 걷기 시뮬레이션 시작',
    demoSimStop: '⏸ 시뮬레이션 정지',
    demoSimNotice: '📍 체험 모드에서만 활성화되는 기능이에요 · 실제로 움직일 수 없는 환경을 위한 체험용 기능이에요 (1초에 2걸음씩 자동 이동)',
    classDodamLoading: '불러오는 중...',
    classDodamLoadFail: '불러오기 실패',
  ...
  en: {
    recordsBtnLabel: 'Records',
    recordsTitle: 'My Records',
    recordsTabToday: 'Today',
    recordsTabPeriod: 'Period',
    recordsTabRanking: 'Ranking',
    recordsTodayMovement: "Today's Movement",
    recordsTodayKnowledge: "Today's Knowledge",
    recordsUnitSteps: 'steps',
    recordsUnitKcal: 'kcal',
    recordsUnitMinutes: 'min',
    recordsUnitCards: 'Cards collected',
    recordsUnitQuiz: 'Correct answers',
    recordsDailyGoal: 'Daily goal: 60 min',
    recordsPeriodWeek: 'This week (since Sunday)',
    recordsPeriodMonth: 'This month',
    recordsPeriodTotal: 'All time since starting',
    recordsUnitActivityMin: 'active min',
    rankCollection: 'Card Collector',
    rankSteps: 'Step Master',
    rankQuiz: 'Quiz Master',
    rankAttendance: 'Consistency Star',
    rankUnitCards: ' cards',
    rankUnitSteps: ' steps',
    rankUnitQuiz: ' correct',
    rankUnitDays: 'days',
    rankNoteWeek: 'This week',
    rankNoteTotal: 'All time',
    rankMe: 'Me',
    rankFooter: 'Showing top 5 + your rank',
    rankRefreshNote: 'Updates about every hour',
    rankResetWeekly: 'Ranking resets every Sunday — a fresh start each week!',
    rankResetQuarterly: 'Shows your last 3 months — celebrating long-term consistency!',
    rankPeriodWeek: 'Weekly',
    rankPeriodMonth: 'Monthly',
    rankPeriodTotal: 'All-time',
    rankResetWeeklyShort: 'Resets every week',
    rankResetMonthlyShort: 'Resets on the 1st of each month',
    rankResetTotalShort: 'Never resets — keeps adding up',
    badgeSprout: 'Sprout Walker',
    badgeStrong: 'Strong Walker',
    badgeChampion: 'Explorer Champion',
    activitySimilarTo: ' min',
    activityJumpRope: 'jump rope',
    activitySoccer: 'soccer',
    activityInlineSkate: 'inline skating',
    activityBadminton: 'badminton',
    activityCycling: 'cycling',
    activityHulaHoop: 'hula hoop',
    recordsLoading: 'Loading...',
    recordsLoadFail: "Couldn't load the ranking.<br>Please check your internet connection.",
    rankClassLabel: 'Class ',
    rankNumberLabel: 'No. ',
    ...
    classDodamTitle: '✨🌿 Our Class Collection, Blooming Together',
    classDodamDetailBtn: '📋 View Details',
    classDodamDetailTitle: '🌿 Our Class Collection',
    classDodamOwnedBy: '👥 Class {class}, No. {numbers}',
    classDodamNoOwner: '👥 No one in our class has this yet',
    classDodamCardUndiscovered: 'No one has collected this yet.',
    demoSimStart: '🎬 Start Walk Simulation',
    demoSimStop: '⏸ Stop Simulation',
    demoSimNotice: '📍 Available in demo mode only · For environments where you can\'t move around (auto-walks 2 steps per second)',
    classDodamLoading: 'Loading...',
    classDodamLoadFail: 'Failed to load',
    ...
    rewardArriveBtn: 'OK!',
    settingsCopyright: '📋 Sources & Licenses',
  ...
  ru: {
    recordsBtnLabel: 'Записи',
    recordsTitle: 'Мои записи',
    recordsTabToday: 'Сегодня',
    recordsTabPeriod: 'Период',
    recordsTabRanking: 'Рейтинг',
    recordsTodayMovement: 'Активность сегодня',
    recordsTodayKnowledge: 'Знания сегодня',
    recordsUnitSteps: 'шагов',
    recordsUnitKcal: 'ккал',
    recordsUnitMinutes: 'мин',
    recordsUnitCards: 'Собрано карт',
    recordsUnitQuiz: 'Правильных ответов',
    recordsDailyGoal: 'Цель на день: 60 мин',
    recordsPeriodWeek: 'На этой неделе (с воскресенья)',
    recordsPeriodMonth: 'В этом месяце',
    recordsPeriodTotal: 'Всего с начала',
    recordsUnitActivityMin: 'мин активности',
    rankCollection: 'Коллекционер',
    rankSteps: 'Мастер шагов',
    rankQuiz: 'Мастер викторин',
    rankAttendance: 'Звезда постоянства',
    rankUnitCards: 'шт',
    rankUnitSteps: 'шагов',
    rankUnitQuiz: 'вопросов',
    rankUnitDays: 'дней',
    rankNoteWeek: 'На этой неделе',
    rankNoteTotal: 'Всего',
    rankMe: 'Я',
    rankFooter: 'Показаны топ-5 и ваше место',
    rankRefreshNote: 'Обновляется примерно раз в час',
    rankResetWeekly: 'Рейтинг обновляется каждое воскресенье — новая неделя, новый шанс!',
    rankResetQuarterly: 'Показаны последние 3 месяца — за постоянство на долгом пути!',
    rankPeriodWeek: 'Неделя',
    rankPeriodMonth: 'Месяц',
    rankPeriodTotal: 'Всего',
    rankResetWeeklyShort: 'Сбрасывается каждую неделю',
    rankResetMonthlyShort: 'Сбрасывается 1-го числа месяца',
    rankResetTotalShort: 'Никогда не сбрасывается — накапливается',
    badgeSprout: 'Юный ходок',
    badgeStrong: 'Сильный ходок',
    badgeChampion: 'Чемпион исследователь',
    activitySimilarTo: ' мин',
    activityJumpRope: 'скакалка',
    activitySoccer: 'футбол',
    activityInlineSkate: 'роликовые коньки',
    activityBadminton: 'бадминтон',
    activityCycling: 'велосипед',
    activityHulaHoop: 'хулахуп',
    recordsLoading: 'Загрузка...',
    recordsLoadFail: 'Не удалось загрузить рейтинг.<br>Проверьте подключение к интернету.',
    rankClassLabel: 'Класс ',
    rankNumberLabel: '№ ',
    ...
    classDodamTitle: '✨🌿 Наша общая коллекция класса',
    classDodamDetailBtn: '📋 Подробнее',
    classDodamDetailTitle: '🌿 Наша коллекция класса',
    classDodamOwnedBy: '👥 Класс {class}, № {numbers}',
    classDodamNoOwner: '👥 Пока никто в классе этого не собрал',
    classDodamCardUndiscovered: 'Пока никто не собрал эту карточку.',
    demoSimStart: '🎬 Начать симуляцию ходьбы',
    demoSimStop: '⏸ Остановить симуляцию',
    demoSimNotice: '📍 Доступно только в демо-режиме · Для мест, где нельзя двигаться (2 шага в секунду автоматически)',
    classDodamLoading: 'Загрузка...',
    classDodamLoadFail: 'Ошибка загрузки',
    ...
    rewardArriveBtn: 'ОК!',
    settingsCopyright: '📋 Источники и лицензии',
  ...
  zh: {
    ...
    recordsTabToday: '今天',
    recordsTabPeriod: '周期',
    recordsTabRanking: '排名',
    recordsTodayMovement: '今日活动',
    recordsTodayKnowledge: '今日知识',
    recordsUnitSteps: '步',
    recordsUnitKcal: '千卡',
    recordsUnitMinutes: '分钟',
    recordsUnitCards: '收集卡片',
    recordsUnitQuiz: '答对题数',
    recordsDailyGoal: '每日目标60分钟',
    recordsPeriodWeek: '本周（从周日起）',
    recordsPeriodMonth: '本月',
    recordsPeriodTotal: '开始以来累计',
    recordsUnitActivityMin: '活动分钟',
    rankCollection: '收集达人',
    rankSteps: '步数达人',
    rankQuiz: '答题达人',
    rankAttendance: '坚持之星',
    ...
    rankNoteTotal: '累计',
    rankMe: '我',
    rankFooter: '仅显示前5名+我的排名',
    rankRefreshNote: '约每小时更新一次',
    rankResetWeekly: '每周日排名重置——每周都是新的开始！',
    rankResetQuarterly: '显示最近3个月的记录——为长期坚持喝彩！',
    rankPeriodWeek: '本周',
    rankPeriodMonth: '本月',
    rankPeriodTotal: '总计',
    rankResetWeeklyShort: '每周重置',
    rankResetMonthlyShort: '每月1日重置',
    rankResetTotalShort: '永不重置，持续累计',
    badgeSprout: '幼苗行者',
    badgeStrong: '强壮行者',
    badgeChampion: '探险冠军',
    activitySimilarTo: '分钟',
    activityJumpRope: '跳绳',
    activitySoccer: '足球',
    activityInlineSkate: '轮滑',
    activityBadminton: '羽毛球',
    activityCycling: '骑自行车',
    activityHulaHoop: '呼啦圈',
    recordsLoading: '加载中...',
    recordsLoadFail: '无法加载排名。<br>请检查网络连接。',
    rankClassLabel: '',
    rankNumberLabel: '号',
    langBtnLabel: '中文',
    exploreBtn: '探索!',
    ...
    classDodamTitle: '✨🌿 齐心协力的班级共同图鉴',
    classDodamDetailBtn: '📋 查看详情',
    classDodamDetailTitle: '🌿 我们班的共同图鉴',
    classDodamOwnedBy: '👥 {class}班{numbers}号拥有',
    classDodamNoOwner: '👥 我们班还没有人拥有',
    classDodamCardUndiscovered: '还没有人收集到这张卡片。',
    demoSimStart: '🎬 开始步行模拟',
    demoSimStop: '⏸ 停止模拟',
    demoSimNotice: '📍 仅在体验模式下可用 · 适用于无法实际走动的环境（每秒自动前进2步）',
    classDodamLoading: '加载中...',
    classDodamLoadFail: '加载失败',
...
function applyUIText(langCode) {
  ...
  if (recordsBtn) recordsBtn.innerHTML = `📊<br>${ui.recordsBtnLabel}`;
