...
function showSettingsPopup() {
  ...
  popup.innerHTML = `
    ...
    <!-- [한글 주석] 오픈소스 및 콘텐츠 안내 -->
    <button onclick="document.getElementById('settings-popup')?.remove(); showCopyrightPopup();" style="
...
function showCopyrightPopup() {
  ...
  popup.innerHTML = `
    <div style="
      ...
      max-width:320px;
      width:100%;
      box-shadow:0 0 40px rgba(141,176,92,0.2);
    ">
      ...
      <div style="color:#d4c89c;font-size:11px;line-height:1.6;margin-bottom:14px;">
      ...
      <button onclick="document.getElementById('copyright-popup').remove()" style="
        ...
        background:linear-gradient(135deg,#6b8e3d,#4a6a2d);
        color:#f0e6c8;border:none;border-radius:12px;
