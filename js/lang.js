...
function showCopyrightPopup() {
  ...
  var texts = {
    ...
    en: {
      ...
      confirm: 'OK',
      items: [
        ['🖼️', 'Card Images', 'Generated with Google Gemini'],
        ['🎬', 'Opening Video', 'Generated with Google Gemini'],
        ['🧍', 'Avatar', 'Cozy People (purchased license)'],
        ['😊', 'Emoji', 'Google Noto Emoji (Apache 2.0)'],
        ['🔤', 'Font', 'Noto Sans KR (SIL Open Font License)'],
        ['🗺️', 'Map', 'Leaflet.js (BSD License)'],
        ['🎵', 'Background Music', 'Pixabay (Pixabay Content License)'],
        ['🔊', 'Sound Effects', 'Self-made (Web Audio API)'],
    ...
    ru: {
      ...
      confirm: 'ОК',
      items: [
        ['🖼️', 'Изображения карточек', 'Создано с Google Gemini'],
        ['🎬', 'Вступительное видео', 'Создано с Google Gemini'],
        ['🧍', 'Аватар', 'Cozy People (купленная лицензия)'],
        ['😊', 'Эмодзи', 'Google Noto Emoji (Apache 2.0)'],
        ['🔤', 'Шрифт', 'Noto Sans KR (SIL Open Font License)'],
        ['🗺️', 'Карта', 'Leaflet.js (BSD License)'],
        ['🎵', 'Фоновая музыка', 'Pixabay (Pixabay Content License)'],
        ['🔊', 'Звуковые эффекты', 'Собственная разработка (Web Audio API)'],
    ...
    zh: {
      ...
      confirm: '确认',
      items: [
        ['🖼️', '卡片图片', '使用Google Gemini生成'],
        ['🎬', '开场视频', '使用Google Gemini生成'],
        ['🧍', '头像', 'Cozy People（购买许可）'],
        ['😊', '表情符号', 'Google Noto Emoji (Apache 2.0)'],
        ['🔤', '字体', 'Noto Sans KR (SIL Open Font License)'],
        ['🗺️', '地图', 'Leaflet.js (BSD License)'],
        ['🎵', '背景音乐', 'Pixabay (Pixabay Content License)'],
        ['🔊', '音效', '自制 (Web Audio API)'],
        ['🎨', 'UI设计', '自制 (HTML/CSS)']
      ]
    }
